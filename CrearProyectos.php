<?php
   ...
   if(!empty($_POST)){
        ...
        if(proyectoExiste($nom_proyecto))
        {
        ...
        $registro = crearProyecto($nom_proyecto, $tema, $fecha_inicial, $fecha_final, $estado, $participantes, $encargado);
   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
			...
			<form action="Tareas.php" method="POST">
			 <input class="controls" type="text" name="Nombre_del_proyecto" value="<?php if(isset($nom_proyecto)) echo $nom_proyecto; ?>" placeholder="Proyecto">
			 <input class="controls" type="text" name="Tema" value="<?php if(isset($Tema)) echo $tema; ?>" placeholder="Tema">
			 ...
			 <input class="controls" type="text" name="encargado" value="<?php if(isset($encargado)) echo $encargado; ?>" placeholder="Encargado">
